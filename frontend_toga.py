# Frontend.py - کامل با ثبت نام معلم
import toga
...
class QuranApp(toga.App):
    ...
    def show_login_screen(self):
        ...
        self.username_input = toga.TextInput(placeholder="Username", style=Pack(padding=10))
        self.password_input = toga.PasswordInput(placeholder="Password", style=Pack(padding=10))
        
        login_btn = toga.Button("🔐 Login", on_press=self.login, style=Pack(padding=15, background_color="#4CAF50", color="white"))
        register_student_btn = toga.Button("🎓 Register Student", on_press=self.show_register_student, style=Pack(padding=15, background_color="#2196F3", color="white"))
        register_teacher_btn = toga.Button("👨‍🏫 Register Teacher", on_press=self.show_register_teacher, style=Pack(padding=15, background_color="#FF9800", color="white"))
    ...
    def show_register_student(self, widget):
        ...
        title_label = toga.Label("🎓 Register Student", style=Pack(text_align=CENTER, font_size=20, font_weight="bold", padding=10))
        ...
        self.password_input = toga.PasswordInput(placeholder="Password", style=Pack(padding=10))
        self.level_input = toga.Selection(items=["Beginner", "Intermediate", "Advanced"], style=Pack(padding=10))
        
        register_btn = toga.Button("✅ Register", on_press=self.register_student, style=Pack(padding=15, background_color="#4CAF50", color="white"))
        back_btn = toga.Button("↩️ Back", on_press=self.show_login_screen, style=Pack(padding=15, background_color="#f44336", color="white"))
    ...
    def show_register_teacher(self, widget):
        ...
        title_label = toga.Label("👨‍🏫 Register Teacher", style=Pack(text_align=CENTER, font_size=20, font_weight="bold", padding=10))
        ...
        register_btn = toga.Button("✅ Register", on_press=self.register_teacher, style=Pack(padding=15, background_color="#4CAF50", color="white"))
        back_btn = toga.Button("↩️ Back", on_press=self.show_login_screen, style=Pack(padding=15, background_color="#f44336", color="white"))
    ...
    def login(self, widget):
        try:
            response = requests.post(
                ...
                json={"username": self.username_input.value, "password": self.password_input.value},
